...
class SocialMediaPoster(QWidget):
    ...
    def setup_services(self):
        ...
        self.content_service = ContentService(ContentGenerator())
    ...
    def publish_posts(self):
        ...
        if not any(selected_platforms.values()):
            self.show_message("Error", "Please select at least one platform to post to.")
            return

        success_platforms, failed_platforms = self.publishing_service.publish_to_platforms(
